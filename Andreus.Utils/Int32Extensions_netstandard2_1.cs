...
namespace Andreus.Utils
{
    ...
    public static partial class Int32Extensions
    {
        ...
        public static int ParseInvariant(ReadOnlySpan<char> s)
        {
        ...
        public static bool TryParseInvariant(ReadOnlySpan<char> s, out int value)
        {
        ...
        public static bool TryFormatInvariant(this int value, Span<char> destination, out int charsWritten, ReadOnlySpan<char> format = default)
        {
