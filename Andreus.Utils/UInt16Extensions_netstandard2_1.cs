...
namespace Andreus.Utils
{
    ...
    public static partial class UInt16Extensions
    {
        ...
        public static ushort ParseInvariant(ReadOnlySpan<char> s)
        {
        ...
        public static bool TryParseInvariant(ReadOnlySpan<char> s, out ushort value)
        {
        ...
        public static bool TryFormatInvariant(this ushort value, Span<char> destination, out int charsWritten, ReadOnlySpan<char> format = default)
        {
