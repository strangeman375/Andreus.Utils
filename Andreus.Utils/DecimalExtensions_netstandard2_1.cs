...
namespace Andreus.Utils
{
    ...
    public static partial class DecimalExtensions
    {
        ...
        public static decimal ParseInvariant(ReadOnlySpan<char> s)
        {
        ...
        public static bool TryParseInvariant(ReadOnlySpan<char> s, out decimal value)
        {
            return decimal.TryParse(s, NumberStyles.Number, NumberFormatInfo.InvariantInfo, out value);
        }
        ...
        public static bool TryFormatInvariant(this decimal value, Span<char> destination, out int charsWritten, ReadOnlySpan<char> format = default)
        {
