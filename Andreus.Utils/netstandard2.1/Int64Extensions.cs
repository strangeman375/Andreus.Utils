...
namespace Andreus.Utils
{
    ...
    public static partial class Int64Extensions
    {
        ...
        public static long ParseInvariant(ReadOnlySpan<char> s)
        {
        ...
        public static bool TryParseInvariant(ReadOnlySpan<char> s, out long value)
        {
        ...
        public static bool TryFormatInvariant(this long value, Span<char> destination, out int charsWritten, ReadOnlySpan<char> format = default)
        {
