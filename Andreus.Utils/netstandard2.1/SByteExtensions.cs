...
namespace Andreus.Utils
{
    ...
    public static partial class SByteExtensions
    {
        ...
        public static sbyte ParseInvariant(ReadOnlySpan<char> s)
        {
        ...
        public static bool TryParseInvariant(ReadOnlySpan<char> s, out sbyte value)
        {
        ...
        public static bool TryFormatInvariant(this sbyte value, Span<char> destination, out int charsWritten, ReadOnlySpan<char> format = default)
        {
