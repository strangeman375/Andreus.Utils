...
namespace Andreus.Utils
{
    ...
    public static partial class Int16Extensions
    {
        ...
        public static short ParseInvariant(ReadOnlySpan<char> s)
        {
        ...
        public static bool TryParseInvariant(ReadOnlySpan<char> s, out short value)
        {
        ...
        public static bool TryFormatInvariant(this short value, Span<char> destination, out int charsWritten, ReadOnlySpan<char> format = default)
        {
